    ...
    var T = {
        en: {
            ...
            index: {
                ...
                newsBtn: 'Read News',
                installBadge: 'Solar installation',
                installTitle: 'Solar panels, inverters, and full on-site setup',
                installDesc: 'We design and install complete solar energy systems for homes and businesses, including panels, inverters, mounting, wiring, grid-ready setup, and on-site configuration.',
                installPoint1: 'Panel installation',
                installPoint2: 'Inverter setup',
                installPoint3: 'Site assessment',
                installPoint4: 'System commissioning',
                installCall: 'Contact us: +994 50 418 00 01',
                installEstimate: 'Estimate system size',
                blogsKicker: 'Insights',
            ...
            calculator: {
                ...
                phoneSub: 'Enter your phone number to calculate your solar system estimate.',
                phoneLabel: 'Phone number',
                phoneSubmit: 'Continue to calculation',
        ...
        az: {
            ...
            index: {
                ...
                installBadge: 'Günəş quraşdırılması',
                installTitle: 'Günəş panelləri, inverterlər və tam yerində quraşdırma',
                installDesc: 'Evlər və bizneslər üçün panellər, inverterlər, montaj, kabel bağlantıları, şəbəkəyə hazır qurulum və yerində konfiqurasiya daxil olmaqla tam günəş enerji sistemləri layihələndirir və quraşdırırıq.',
                installPoint1: 'Panel quraşdırılması',
                installPoint2: 'Inverter qurulması',
                installPoint3: 'Sahə qiymətləndirilməsi',
                installPoint4: 'Sistemin işə salınması',
                installCall: 'Bizimlə əlaqə: +994 50 418 00 01',
                installEstimate: 'Sistem ölçüsünü hesabla',
                blogsKicker: 'Təhlillər',
            ...
            calculator: {
                ...
                phoneTitle: 'Əlaqə nömrəsi',
                phoneSub: 'Günəş sistemi hesablamasını görmək üçün telefon nömrənizi daxil edin.',
                phoneLabel: 'Telefon nömrəsi',
                phoneSubmit: 'Hesablamaya davam et',
        ...
        ru: {
            ...
            index: {
                ...
                installBadge: 'Установка солнечных систем',
                installTitle: 'Солнечные панели, инверторы и полный монтаж на объекте',
                installDesc: 'Мы проектируем и устанавливаем солнечные энергосистемы для домов и бизнеса: панели, инверторы, крепления, кабели, подготовку к сети и настройку на объекте.',
                installPoint1: 'Монтаж панелей',
                installPoint2: 'Настройка инвертора',
                installPoint3: 'Оценка объекта',
                installPoint4: 'Запуск системы',
                installCall: 'Связаться: +994 50 418 00 01',
                installEstimate: 'Оценить размер системы',
                blogsKicker: 'Материалы',
            ...
            calculator: {
                ...
                phoneTitle: 'Контактный номер',
                phoneSub: 'Введите номер телефона, чтобы рассчитать вашу солнечную систему.',
                phoneLabel: 'Номер телефона',
                phoneSubmit: 'Перейти к расчету',
