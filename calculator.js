...
async function submitCalculatorData(phoneNumber, calculationData) {
    try {
        ...
        const payload = {
            ...
            house_size_m2: calculationData.input_data.house_size_m2,
            people_count: calculationData.input_data.people_count,
            daytime_occupancy: calculationData.input_data.daytime_occupancy,
            electric_cooking: calculationData.input_data.electric_cooking,
            heavy_ac: calculationData.input_data.heavy_ac,
            water_heater: calculationData.input_data.water_heater,
